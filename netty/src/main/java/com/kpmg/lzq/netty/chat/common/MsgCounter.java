package com.kpmg.lzq.netty.chat.common;
...
public class MsgCounter {
    ...
    public static void count() {
        ...
        if ((finishCount == MsgConstant.COUNT_LEVEL_1 || finishCount == MsgConstant.COUNT_LEVEL_2 || finishCount == MsgConstant.COUNT_LEVEL_3) && count % 6 == 0) {
